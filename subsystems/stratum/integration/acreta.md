...
`accreta/.worklist/insecure/all/` es una capa del proyecto principal Accreta, siguiendo la convención `.stratum/`. Es el lugar donde viven los ítems de worklist del ecosistema completo.
