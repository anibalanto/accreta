...
El corte a 4.0.0 degradó 165 vecindarios a `n: declined` y con eso tiró dos sha256 por endpoint. Se pueden recuperar, y **están vivos por accidente**: siguen en los `.bilink-formato-3/` de cada capa porque nadie los borró todavía.
