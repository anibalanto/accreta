...
3. Para cada endpoint estructural, lee su capture y extrae `(archivo, uuid, N, capture-uuid)`.
4. Escribe `.bilink/index/index` con una línea `<archivo>\t<uuid>.<N>\t<capture-uuid>` por entrada.
