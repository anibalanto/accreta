...
bilinker chain new \
  ...
  --tip .stratum/tech-decisions/.stratum/impl "java-demo :: src/.../Persona.java :: (class_declaration ...)"
```
...
Created chain: 7f3d8e9a-1b2c-4d5e-8f6a-7b8c9d0e1f2a
  ...
  .stratum/tech-decisions/.bilink/7f3d8e9a-….bilink           (mid)
  .stratum/tech-decisions/.stratum/impl/.bilink/7f3d8e9a-….bilink  (tip)
...
Chain: 7f3d8e9a-1b2c-4d5e-8f6a-7b8c9d0e1f2a  [DIRTY]
  ...
  .stratum/impl/                   (tip)   (CHAIN_DIRTY, ALTERED)
    link.0  → tech-decisions layer         CHAIN_DIRTY
...
7f3d8e9a-1b2c-4d5e-8f6a-7b8c9d0e1f2a  [DIRTY]   spec → tech-decisions → impl
