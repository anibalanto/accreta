...
`accreta/.stratum/worklist/` sigue exactamente la convención `.stratum/` de Stratum: es una capa interna del proyecto principal Accreta, no un sub-proyecto hermano.
