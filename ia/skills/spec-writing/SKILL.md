...
5. **La spec vieja se borra en accreta, y sus bilinks se borran con ella, de los dos lados.** Con `bilinker remove` en accreta y en el impl: un borrado de un solo lado deja al otro `BROKEN`. Es la regla de la decisión 6 —un bilink que no se va a re-aceptar se borra—, y el rastro queda en la historia de `refs/bilink/<branch>`. Medido el 2026-09-15: 197 espejos siguieron vivos en los impls dos días, porque el borrado de accreta viajó adentro de un `accept` y nada lo decía.
